    ...
    $("#subir_archivo").click(function () {
        ...
        if (inputFile) {
            ...
            if (inputFile.size > maxSize) {
                ...
                $("#subir_archivo").html(`<i class="fa-solid fa-upload"></i> Subir archivo`);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (responseObject.status === "error") {
                        var errors = responseObject.errors.map((error) => `<li>${error}</li>`).join("");
                        var alertHtml = `<div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    if (response.exists == 0) {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $("#toast-body").html("El usuario fue asignado correctamente al alumnos");
                                    ...
                                    action: function () {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (response) {
                                                ...
                                                $("#toast-body").html("Usuario reasignado correctamente");
                                                $("#response-toast").toast("show");
                                            },
                                            error: function () {
                                                $.confirm({
