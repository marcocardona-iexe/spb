$(document).ready(function () {
	...
	window.probabilidad_baja = (matricula) => { //cambio
		$.confirm({
			title: false,
			closeIcon: true,
	...
	function configurarTablaAlumnos(url = "https://app.iexe.edu.mx/seguimiento/alumnosController_copia/data_tabla_inicial", data = null) {
		let ajaxConfig = {
			url: url,
	...
	window.bloqueados = function () {
		...
		// Configurar la tabla con la URL específica
		const table = configurarTablaAlumnos("alumnos_bloqueados");
	...
	window.inscritos = function () {
		...
		// Configurar la tabla con la URL específica
		const table = configurarTablaAlumnos("alumnos_inscritos");
	...
	window.Activos = function () {
		...
		// Configurar la tabla con la URL específica
		const table = configurarTablaAlumnos("alumnos-activos");
